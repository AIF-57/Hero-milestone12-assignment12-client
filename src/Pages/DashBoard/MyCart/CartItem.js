...
const CartItem = ({itemDetail, handlePaymentStatus, setDeleteCartItem}) => {
    ...
    return (
        <div className='flex flex-col items-center min-h-[100px] justify-center py-0 border-b'>
            <div className='w-full h-full grid grid-cols-8 items-center'>
                <div className="itemImg w-full h-full">
                    <img src={item.Image} alt="" width='100'/>
                </div>
                <p className='col-span-3 text-secondary font-semibold text-lg'>{item.Model}</p>

                <div className="priceCalculation flex justify-evenly col-span-2 font-semibold text-neutral">
                    <p>{item.MSRP}</p>
